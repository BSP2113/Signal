...
PER_DAY_GROWTH_EX2 = {
    ...
    "2026-05-21": [
        (
            "PM_ORB went 3-for-3 with all MAYBE ratings reaching TIME_CLOSE \u2014 MAYBE tier earning its keep on neutral days",
            "All three PM_ORB signals today (SNDK +$14.53, META +$15.50, COIN +$13.10) entered as MAYBE-rated and all three rode to the 14:00 TIME_CLOSE for a combined +$43.13 with no stops triggered. None hit TAKE_PROFIT (+3%) \u2014 gains were modest (1.05%, 1.45%, 1.99%) but consistent. COIN's 3.6x volume was the strongest conviction yet only delivered +1.45%, while SNDK's 1.7x produced the largest % gain. This suggests PM_ORB on a NEUT day produces a tight, low-variance distribution of small winners \u2014 exactly the regime where TIME_CLOSE harvests gains that would otherwise round-trip. Re-entries contributed nothing (zero fires) so the entire EX2 vs EX1 delta of +$31.28 came from PM_ORB after the 75% allocation haircut. Test: track PM_ORB MAYBE-only win rate over next 10 sessions; if >65% with avg gain >+1%, raise MAYBE allocation from 75% to 90% of TAKE size on NEUT days specifically."
        ),
        (
            "PM_ORB entries all clustered 13:00\u201313:10 \u2014 early-window bias confirmed for a third consecutive session",
            "SNDK fired at 13:00, META at 13:04, COIN at 13:10 \u2014 every PM_ORB today triggered in the first 10 minutes of the eligible 12:44\u201313:30 window, and all three were profitable. The 13:10\u201313:30 portion of the window contributed zero signals again. This pattern matches the recent trend where late-window PM_ORBs (13:20+) have been weaker entries because they catch breakouts already extended from the morning high. Tightening the window would not have changed today's results but would reduce false positives on choppier days. Test: on the next 5 sessions, log PM_ORB signals 13:10\u201313:30 separately; if late-window entries underperform early-window by >50 bps avg, cut the PM_ORB window to 12:44\u201313:15."
        ),
        (
            "Zero re-entry signals on a day with two EX1 winners \u2014 re-entry layer kept quiet correctly",
